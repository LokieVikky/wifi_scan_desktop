...
namespace wifi_scan_windows
{
    ...
    // static
    void WifiScanWindowsPlugin::RegisterWithRegistrar(
        flutter::PluginRegistrarWindows *registrar)
    {
        ...
        auto plugin = std::make_unique<WifiScanWindowsPlugin>();
    ...
    WifiScanWindowsPlugin::WifiScanWindowsPlugin() {}

    WifiScanWindowsPlugin::~WifiScanWindowsPlugin() {}

    void WifiScanWindowsPlugin::HandleMethodCall(
